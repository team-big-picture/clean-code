...
[SRP(단일 책임 원칙 - Single Responsibility Principle)]나 [DIP(의존 관계 역전 원칙 - Dependency Inversion Principle)]와 같은 원칙을 쉽게 적용할 수 있도록 하는 규칙이 있을까?
